...
<title><?php echo $__env->yieldContent('title', 'Beranda'); ?> — Pegadaian Admin</title>
...
<nav class="sidebar">
  ...
  <div class="nav-group">
    ...
    <a href="<?php echo e(route('barang.index')); ?>" class="nav-item <?php echo e(request()->routeIs('barang.*') ? 'active' : ''); ?>">
      <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2">
        <path d="M20 7H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2z"/>
        <path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/>
      </svg>Barang Gadai
    </a>
    <a href="<?php echo e(route('riwayat.index')); ?>" class="nav-item <?php echo e(request()->routeIs('riwayat.*') ? 'active' : ''); ?>">
      <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2">
        <path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>Riwayat
    </a>
    <a href="<?php echo e(route('keuangan.index')); ?>" class="nav-item <?php echo e(request()->routeIs('keuangan.*') ? 'active' : ''); ?>">
      <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2">
  ...
  <div class="sidebar-policy">
    ...
    <div class="sp-row"><span class="sp-key">Tebus &gt; ½ masa</span><span class="sp-val b"><?php echo e(config('pegadaian.bunga_normal')); ?>%</span></div>
    <div class="sp-row"><span class="sp-key">Tebus ≤ ½ masa</span><span class="sp-val g"><?php echo e(config('pegadaian.bunga_khusus')); ?>% ⚡</span></div>
    <div class="sp-sep"></div>
    <div class="sp-row"><span class="sp-key">Biaya perpanjang</span><span class="sp-val w"><?php echo e(config('pegadaian.biaya_perp')); ?>%</span></div>
  </div>
...
<div class="main">
  <div class="topbar">
    <div><div class="page-title"><?php echo $__env->yieldContent('page-title', 'Beranda'); ?></div></div>
...
<?php /**PATH C:\laragon\www\Gadai\resources\views/layouts/app.blade.php ENDPATH**/ ?>