<?php $__env->startSection('title', 'Tambah Barang Gadai'); ?>
...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px">
  ...
  <a href="<?php echo e(route('barang.index')); ?>" class="btn btn-ghost">← Kembali</a>
</div>

<div class="card">
  <div class="card-header">
    <div class="card-title">📋 Form Gadai Baru — <span style="color:var(--primary);font-weight:900"><?php echo e($kodeGadai); ?></span></div>
  </div>
  <div class="card-body">
      ...
      <div class="form-section">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" name="nasabah" class="form-control" placeholder="Nama lengkap" value="<?php echo e(old('nasabah')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <input type="text" name="ktp" class="form-control" placeholder="16 digit NIK" value="<?php echo e(old('ktp')); ?>" maxlength="20">
          </div>
        </div>
        <div class="form-group" style="max-width:50%">
          <label class="form-label">No. Telepon</label>
          <input type="text" name="no_telp" class="form-control" placeholder="628xxxxxxxxxx" value="<?php echo e(old('no_telp')); ?>">
        </div>
      </div>
      ...
      <div class="form-section">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" name="barang" class="form-control" placeholder="Contoh: iPhone 15 Pro 256GB" value="<?php echo e(old('barang')); ?>" required>
          </div>
          <div class="form-group">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="number" name="nilai_taksiran" class="form-control" placeholder="0" value="<?php echo e(old('nilai_taksiran')); ?>" min="1" required>
          </div>
          <div class="form-group">
            <label class="form-label">Nilai Pinjaman (Rp) <span style="color:var(--red)">*</span></label>
            <input type="number" name="nilai_pinjaman" id="nilaiPinjaman" class="form-control" placeholder="0" value="<?php echo e(old('nilai_pinjaman')); ?>" min="1" required>
            <div class="form-hint">Maksimal sama dengan nilai taksiran</div>
          </div>
        </div>
        <div class="form-group">
          <label class="form-label">Keterangan / Kondisi Barang</label>
          <textarea name="keterangan" class="form-control" placeholder="Kondisi barang, kelengkapan, dll."><?php echo e(old('keterangan')); ?></textarea>
        </div>
      </div>
      ...
      <div class="form-section">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="date" name="tgl_gadai" id="tglGadai" class="form-control" value="<?php echo e(old('tgl_gadai', today()->toDateString())); ?>" required>
          </div>
          <div class="form-group">
            ...
            <select name="bulan_gadai" id="bulanGadai" class="form-control" required>
              <?php for($i = 1; $i <= 12; $i++): ?>
                <option value="<?php echo e($i); ?>" <?php echo e(old('bulan_gadai', 1) == $i ? 'selected' : ''); ?>><?php echo e($i); ?> Bulan</option>
              <?php endfor; ?>
            </select>
          </div>
        </div>
      ...
      <div style="display:flex;gap:10px;justify-content:flex-end">
        <a href="<?php echo e(route('barang.index')); ?>" class="btn btn-ghost">Batal</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Gadai\resources\views/barang/create.blade.php ENDPATH**/ ?>